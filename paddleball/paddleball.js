//based on https://github.com/jakesgordon/javascript-pong
Paddleball = {
  ...
  initialize: function(runner, cfg) {
    ...
    this.court  = Object.construct(Paddleball.Court,  this);
  ...
  constructBalls: function() {
    ...
    for(var n = 0 ; n < this.cfg.balls ; n++)
      balls.push(Object.construct(Paddleball.Ball, this));
    return balls;
  },
  ...
  Court: {
    ...
    initialize: function(paddleball) {
      var w  = paddleball.width;
      var h  = paddleball.height;
      var ww = paddleball.cfg.wallWidth;
  ...
  Ball: {
    ...
    initialize: function(paddleball) {
      ...
      this.minX    = paddleball.cfg.wallWidth + this.radius;
      this.minY    = paddleball.cfg.wallWidth + this.radius;
      this.maxX    = paddleball.width  - paddleball.cfg.wallWidth - this.radius;
      this.maxY    = paddleball.height - paddleball.cfg.wallWidth - this.radius;
